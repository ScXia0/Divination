...
def build_openai_prompt(payload: dict) -> tuple[str, str]:
    ...
    instructions = (
        ...
        "10. 必须直接回应用户问题里的具体动作、对象或场景，例如“打羽毛球”“约饭”“谈晋升”，不要反复泛化成“这件事”“这个安排”；"
        "11. 如果 localQuestion 已经给出了合理方向，请在它的基础上细化，不要把意思改得更空泛；"
        "12. verdict、prepText、encourageText 最好都带上用户原问题里的动作短语，让人一眼看出是在回答同一个问题。"
    )
